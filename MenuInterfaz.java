...
public class MenuInterfaz extends JFrame {
	...
	public MenuInterfaz() {
		...
		panelNickname.setForeground(new Color(0, 0, 0));
		panelNickname.setVisible(ver);
		panelNickname.setBackground(new Color(0, 0, 0));
		panelNickname.setBounds(331, 5, 834, 540);
